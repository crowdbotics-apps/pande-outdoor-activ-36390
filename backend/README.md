...
## Project Structure
    ...
    ├── pande_outdoor_activ_36390  # Django project configurations
...
1. Clone this repo and `cd pande_outdoor_activ_36390`
...
2. Clone this repo and `cd pande_outdoor_activ_36390`
